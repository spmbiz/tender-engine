...
import dce_worker_v18 as v18  # registers the complete v18 stack first
...
def adapter_sk_uvo_v19(candidate: dict, out: Path, manifest: dict) -> None:
    ...
    if documents_url:
        ...
        try:
            ...
            manifest["dce_method_attempts"].append(
                {
                    "method": "SK_UVO_STRONG_DOCUMENT_LINKS_V19",
                    "url": documents_url,
...
base.ADAPTERS["SK_UVO_PUBLIC"] = adapter_sk_uvo_v19
base.ADAPTERS["SK_UVO"] = adapter_sk_uvo_v19
