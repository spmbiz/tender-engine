...
def main():
    ...
    for page in range(MAX_PAGES):
        ...
        for o in projects:
            ...
            # competition phase publications only; remove clear award/result/advance phases.
            if pubtype in ('award_tender','award_study_contract','award_competition','direct_award','advance_notice','revocation','abandonment'):continue
            deadline=None;hasdocs=None;detail_url=None;desc='';cpv=None;details=None
