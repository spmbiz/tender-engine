...
def deadline_contexts(gates: dict, corpus: str) -> tuple[str, dict]:
    ...
    # The full extracted DCE is authoritative whenever gate_readiness=true. Search it
    # directly as a recall rescue so local-language deadlines are not lost merely
    # because a gate-snippet regex dictionary lacks that language.
