...
def main():
    ...
    families=[
      ...
      ('WORKWEAR_PPE_SUPPLY',r'(?i)(supply.*(workwear|\bppe\b|protective clothing|safety footwear)|fourniture.*(vêtements de travail|vetements de travail|\bepi\b|équipements de protection individuelle|equipements de protection individuelle)|lieferung.*(arbeitskleidung|schutzkleidung)|levering.*(werkkleding|persoonlijke beschermingsmiddelen))'),
